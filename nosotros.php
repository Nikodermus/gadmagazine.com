...
<section class="nosotros">
    <article class="fold">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 no-gutter fold--image">
                    <div class="row fold--logo">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 text-xs-center logo--container">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 fold--text">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 front">
                            <h2 class="text-xs-left title f1 space-left">Sobre la revista</h2>
                        </div>
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 offset-xs-2">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 offset-xs-2  f2">
                            <a href="" class="bold link">Facebook</a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 text-xs-right f2">
    ...
    <article class="staff">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 staff--member">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-xs-left">
                                    <a href="https://www.facebook.com/lauritacubillosrico" target="_blank"><i class="icon-">Fb</i></a>
                                </div>
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-xs-center">
                                    <a href="" target="_blank"><i class="icon-">Be</i></a>
                                </div>
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-xs-right">
